...
<node LOCALIZED_TEXT="new_mindmap" LOCALIZED_STYLE_REF="AutomaticLayout.level.root" FOLDED="false" ID="ID_1090958577" CREATED="1409300609620" MODIFIED="1613168066087"><hook NAME="MapStyle" background="#f9f9f8" zoom="0.8">
    <conditional_styles>
...
<stylenode TEXT="customMenuPackage" ID="ID_511712211" ICON_SIZE="20 pt" COLOR="#ffffff" BACKGROUND_COLOR="#388dc6" STYLE="rectangle" SHAPE_HORIZONTAL_MARGIN="5 px" SHAPE_VERTICAL_MARGIN="2 px" BORDER_WIDTH="3 px" BORDER_COLOR="#ae5528">
